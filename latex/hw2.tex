...
\begin{figure}
  \begin{center}
    \includegraphics[width=.4\linewidth]{figs/impsample1cornell}
    \includegraphics[width=.4\linewidth]{figs/impsample10cornell}
    \includegraphics[width=.4\linewidth]{figs/impsample100cornell}
  \end{center}
  \caption{Importance Sampling with 1, 10 and 100 samples}
\end{figure}

\begin{figure}
  \begin{center}
    \includegraphics[width=.4\linewidth]{figs/noimpsample1cornell}
    \includegraphics[width=.4\linewidth]{figs/noimpsample10cornell}
%    \includegraphics[width=.4\linewidth]{figs/noimpsample100cornell}
  \end{center}
  \caption{No Importance Sampling with 1, 10 and 100 samples}
\end{figure}
